...
define('SEC_CREDENTIAL', 'Instalador Eléctrico Autorizado SEC - Clase B');
define('SEC_CLASS', 'Clase B');
define('SEC_RUT', '12.738.961-6');
define('SEC_LICENSE_NUMBER', 'RUT 12.738.961-6');
define('SEC_INSTITUTION', 'IP Santo Tomás');
define('SEC_SPECIALTY', 'Técnico en Electricidad y Electrónica Industrial');
define('SEC_STATUS', 'ACTIVO');
define('SEC_VERIFICATION_URL', 'https://wlhttp.sec.cl/rnii/public/licencia/qr?o=1cdda99e804b48a2aca00851368f5642');
define('SEC_QR_IMAGE', BASE_URL . '/assets/img/qr-sec-electrico-certificado.jpeg');
define('SEC_QR_WEBP', BASE_URL . '/assets/img/qr-sec-electrico-certificado.webp');
define('SEC_CARD_IMAGE', BASE_URL . '/assets/img/credencial-sec-domingo-isain.jpg');
define('SEC_CARD_WEBP', BASE_URL . '/assets/img/credencial-sec-domingo-isain.webp');
define('SEC_CARD_CROP_WEBP', BASE_URL . '/assets/img/credencial-sec-card.webp');
define('SEC_TEAM_NOTE', 'Equipo técnico integral con instaladores autorizados SEC Clase B e ingenieros Clase A para proyectos de alta envergadura.');
