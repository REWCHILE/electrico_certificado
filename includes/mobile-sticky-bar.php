...
<div class="mobile-sticky-bar" role="navigation" aria-label="Contacto urgente móvil">
    <a href="tel:<?= PHONE_RAW ?>" class="mobile-action-btn mobile-call-btn">
    ...
    <a href="https://wa.me/<?= WHATSAPP_NUMBER ?>?text=<?= WHATSAPP_URGENCIA_MSG ?>" target="_blank" rel="noopener" class="mobile-action-btn mobile-whatsapp-btn">
        <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
