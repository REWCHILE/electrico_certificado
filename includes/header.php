    ...
    <div class="top-bar">
        <div class="container">
            ...
            <div class="top-bar-right">
                <span>Registro Oficial: <strong><?= SEC_LICENSE_NUMBER ?></strong></span>
        ...
        <div class="container">
            <div class="header-inner">
                ...
                <div class="header-actions">
                    ...
                    <a href="https://wa.me/<?= WHATSAPP_NUMBER ?>?text=<?= WHATSAPP_DEFAULT_MSG ?>" target="_blank" rel="noopener" class="btn btn-volt btn-sm">
